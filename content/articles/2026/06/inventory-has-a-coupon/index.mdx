...
where $k$ governs how fill probability decays as you quote further from mid (orders arrive with intensity $\lambda(\delta) = A\,e^{-k\delta}$). The bid and ask land at $r \pm \delta/2$. Wider vol, wider spread; more inventory, more skew. Clean.
